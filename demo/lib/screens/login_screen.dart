...
class _LoginState extends State<Login> {
  ...
  Future<void> loginUser() async {
    ...
    final String password = passwordController.text;
    final String selectedRole = 'role'; // Adjust this based on your role selection

    try {
      final Map<String, dynamic>? response = await APIService.loginUser(username, password, selectedRole);
